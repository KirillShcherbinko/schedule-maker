...
import { BASE_NAMESPACE, START_NOW_LINK } from '../../../config/consts';
...
export const StartNow = () => {
  ...
  return (
    <section className="flex flex-col gap-2 bg-block-primary rounded-3xl pt-8 pb-8">
      <h2 className="font-bold text-2xl sm:text-3xl text-center">{t(`${START_NOW_LINK}.title`, BASE_NAMESPACE)}</h2>
