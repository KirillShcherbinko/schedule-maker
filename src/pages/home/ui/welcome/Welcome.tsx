...
const BASE_LINK = 'home.welcome';

export const Welcome = () => {
  const { t } = useTranslation();

  return (
    <section className="flex flex-row items-center mt-20 pr-5 pt-10 pb-10 gap-5 sm:gap-10 lg:gap-20 xl:gap-25 bg-block-primary rounded-4xl">
