...
import { BASE_NAMESPACE_WITH_RETURN, MAIN_FEATURES_LINK } from '../../../config/consts';
import { images } from '../model/consts';
import type { TFeature } from '../model/types';

export const MainFeatures = () => {
  const { t } = useTranslation();
  const mainFeatures = t(MAIN_FEATURES_LINK, BASE_NAMESPACE_WITH_RETURN) as unknown as TFeature[];
